              ...
              <Card className="border-gray-100 shadow-sm">
                <CardHeader className="bg-gray-50/60 border-b border-gray-100">
                  <CardTitle className="text-2xl font-normal text-gray-700">
                    Lab Results for Patient: {patientData.id}
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-6">
                            ...
                            <tr key={lab.id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {lab.status === "pending" ? (
                                  ...
                                  <Badge variant="outline" className="border-green-200 bg-green-50 text-green-700">Completed</Badge>
                                )}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                {lab.status === "pending" ? (
                                  ...
                                  lab.resistanceResult === "positive" ? (
                                    ...
                                    <Badge variant="outline" className="border-green-200 bg-green-50 text-green-700">Negative</Badge>
                                  )
                                )}
                              </td>
                            </tr>
                          ...
                          <tr key={patient.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              {patient.culture_required ? (
                                <Badge variant="outline" className="border-blue-200 bg-blue-50 text-blue-700">Required</Badge>
                              ) : (
          ...
          <TabsContent value="dischargePatient">
            <Card className="border-gray-100 shadow-sm">
              <CardHeader className="bg-gray-50/60 border-b border-gray-100">
                ...
                <CardDescription>Enter the patient ID to discharge</CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <form onSubmit={handleDischargeSubmit} className="max-w-md">
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="dischargePatientId" className="text-lg font-medium mb-2 block">
                        Patient ID
                      </Label>
                      <Input
      ...
      <AlertDialog open={showResultConfirm} onOpenChange={setShowResultConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to record a {selectedResult === "positive" ? "positive" : "negative"} result for sample {selectedSample?.sample_id}?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleConfirmLabResult} disabled={isSubmitting}>
              {isSubmitting ? (
                <>
      ...
      <AlertDialog open={showDischargeConfirm} onOpenChange={setShowDischargeConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to discharge patient {dischargePatientId}?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
